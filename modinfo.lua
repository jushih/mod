...
author = "Julie"
version = "2.3" -- This is the version of the template. Change it to your own number.
...
configuration_options = {
	...
	},
	{
        ...
        label = "Level Key",
        hover = "Button to see your Level.",
        options =
        {
	...
	{
        name = "takumi_stats_key",
        label = "Stats Key",
        hover = "Button to see your Stat gain.",
        options =
        {
            {description="TAB", data = 9},
            {description="KP_PERIOD", data = 266},
